...
const InfoBar = ({ workspaceId }: Props) => {
  ...
  return (
    <header className="pl-20 md:pl-[265px] fixed p-4 w-full flex items-center justify-between gap-4 bg-[#171717]">
      <div className="hidden sm:flex md:flex gap-4 justify-center items-center border-2 rounded-full px-4 w-full max-w-lg">
